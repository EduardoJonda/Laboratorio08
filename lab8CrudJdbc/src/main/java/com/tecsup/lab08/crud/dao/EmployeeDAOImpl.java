...
public class EmployeeDAOImpl implements EmployeeDAO {
	...
	public Employee findByTodo(int id, String name, String last, Double sala, int age) {
		// TODO Auto-generated method stub
		
		ResultSet rs = null;
		PreparedStatement pst = null;
		Connection con = ConnectionDB.getConnection();
		String stm = "Select employee_id, first_name, last_name, salary, age from employees_2 wherse employee_id = ?";
		Employee emp = new Employee();
		try {
			pst = con.prepareStatement(stm);
			pst.setInt(1, id);
